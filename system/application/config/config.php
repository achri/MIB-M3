...
//Tolong Untuk Dibaca 
//
//Comment By Emay ::::Minta Bantuannya Kepada Programmer Purchase
//Sebagai Prototype tolong dibuatkan sebuah variable yang bisa diambil dan
//dipasangkan ke base_url , umpama mudah tp susah seperti ini :
// jika seorang kommit dengan revisi 234 maka akan dibuatkan secara langsung
// untuk direktory release 234 diakses dengan purchase.gus-mib.com/release234
// nah yang saya perlukan adalah :
// di sisi server generate direktory sudah bisa dilakukan spt dalam contoh 
// komit 234 maka sisi server akan langsung membuat /home/web/purchase/release/release234
// nah untuk sisi source codenya tolong dibuatkan sehingga base_url bisa berbentuk 
// seperti ini : $config['base_url'] = "http://".$_SERVER['SERVER_NAME']."/release".$variable_no_revisi
//
// Ini bertujuan untuk :
// 1. Archiving source code release (Tiap Release akan dibuatkan sebuah FolderBaru).
// 2. Menghindari dari kesalahan program 
// 3. Programmer bisa membandingkan antara satu release dengan release yang lain.
// 
//
// saya harap kita bisa bekerja sama untuk memperbaiki dan terus mengembangkan 
// program yang sedang dikembangkan.....These is beginning
// 
// Thx a lot Guys
//
// B regards --- Emay -- 2010
//
//
//$config['base_url']	= "http://192.168.3.6/purchase_united/";

//$config['base_url'] = "http://".$_SERVER['SERVER_NAME'].'/mib_m3';
$config['base_url']	= "http://localhost/mib_m3/";
...
//$config['sess_data_cookie']         = 'sess_storage';
...
$config['sess_gc_probability']      = 100;
