<div id="outerdiv">
<div id="innerdiv">
<form id="myform" class="ui-corner-all cssform" action="<?php echo site_url("login"); ?>" method="post">
<fieldset class="ui-widget-content ui-corner-all"><legend><?=$this->lang->line('login')?></legend>
