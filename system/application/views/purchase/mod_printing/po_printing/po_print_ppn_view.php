...
?>
<div style="font-size: 7pt !important;zoom=1">
			 ...
			 <td colspan="3" valign="top" nowrap>
				<table id="ItemPO" width="100%" border="1" cellspacing="0" cellpadding="2">
					<tr align="center" valign="middle" bgcolor="#FFFFFF"> 
						...
						<td width="20" rowspan="2" align="center" nowrap><strong>Nama barang</strong><br/>
					  <strong>(Kode)</strong></td>
						...
						<td rowspan="2" width="15%" align="center" nowrap><strong>PPN 10%<br>( <?=$content['detail']->row()->cur_symbol?> )</strong></td>
					...
					//if ($detail->cur_symbol == 'Rp'){
						...
						$ppn = number_format($detail->ppn,$detail->cur_digit);
						$hrg_ppn = number_format($detail->sum_ppn,$detail->cur_digit);
					/*}else{
						$price = number_format($detail->price,5);
						$disc = number_format($detail->discount_val,5);
						$amount = number_format($detail->amount,5);
						$ppn = number_format($detail->ppn,5);
						$hrg_ppn = number_format($detail->sum_ppn,5);
					}*/
					...
					<tr bgcolor='#FFFFFF' valign='top'> 
						...
						<td width='20' nowrap="nowrap">
							<table border='0' cellpadding='0' cellspacing='0' width='20'>
								<tr>
									<td width='20' height="100%" nowrap="nowrap"><?=$detail->pro_name?></td>
								</tr>
								<tr>
						...
						<table border='0' cellpadding='0' cellspacing='0' width='100%'>
								<tr>
									<td align='left'><?php echo $detail->satuan_name;?></td>
									<td>&nbsp;</td>
									<td align='right'><?php echo number_format($detail->qty,$detail->satuan_format);?></td>
								</tr>
						</table>
						</td>
						...
						<td align='right' nowrap='nowrap'><?=$ppn?></td>
						<td align='right' nowrap='nowrap'><?=$hrg_ppn?></td>
					...
					if ($detail->cur_id == 1){
						...
						$tot_price = number_format($footer->tot_price,5);
						$tot_disc = number_format($footer->tot_discount,5);
					}
					*/
					?>
					...
					<tr bgcolor="#FFFFFF" align="right"> 
						...
						<td colspan="3"><strong><?=number_format($content['footer']->row()->hrg_ppn,$content['footer']->row()->cur_digit)?></strong></td>
						<td colspan="3">&nbsp;</td>
					</tr>
					<tr bgcolor="#FFFFFF" align="right"> 
						<td colspan="4"><STRONG>TOTAL KESELURUHAN</STRONG></td>
						<td colspan="4"><strong><?=number_format($content['footer']->row()->tot_ppn,$content['footer']->row()->cur_digit)?></strong></td>
						<td colspan="2">&nbsp;</td>
					</tr>
