<script type="text/javascript">
	function print_so(id,count,tgl){
		$.ajax({
			type: 'POST',
			url: 'index.php/<?=$link_controller?>/print_update/'+id+'/'+count+'/'+tgl,
			success: function() {
			window.print();
			$('#print').hide();
			}
	...
	<tr bgcolor="#FFFFFF">
		<td>
		 <table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
			 <td colspan="2" valign="top" nowrap><span style="font-size:18pt;font-weight:bold;text-decoration:underline;">SERVICE ORDER</span></td>
			 <td align="right" valign="middle" nowrap rowspan="2">
			   <table width="90%" border="0" cellspacing="0" cellpadding="0">
			    <tr> 
				 <td width="50%" align="left">Nomor SO</td>
				 <td width="10">:</td>
				 <td width="40%" align="left"><span style="font-size:12pt;font-weight:bold;"><?php echo $head->so_no; 
				 	if ($head->so_printCounter != '0'){
				 		echo " (r".$head->so_printCounter.")";
				 	}?>
				 </span></td>
				</tr>
				<tr> 
				 <td align="left">Tanggal SO</td>
				 <td>:</td>
				 <td align="left"><?php echo $head->so_date;?></td>
				</tr>
			 ...
			 <td colspan="3" valign="top" nowrap>
				<table id="ItemPO" width="100%" border="1" cellspacing="0" cellpadding="2">
					...
					echo "<tr bgcolor='#FFFFFF' valign='top'> 
						...
						<td align='center' colspan='2'>".$detail->srfq_delivery_date."</td>
					</tr>";
					endforeach;
					...
					<tr bgcolor="#FFFFFF" align="right"> 
						...
						foreach ($content['footer']->result() as $foot):
							if ($foot->cur_id == '1'){
								$tot_price = number_format($foot->tot_price,2);
							}else{
								$tot_price = number_format($foot->tot_price,2);
							}	
							echo "<tr>
...
<input type="button" onclick="print_so('<?php echo $head->so_id."','".$head->so_printCounter."','".$head->so_date; ?>')" value="Cetak" class="noprint" id="print">
<?php 
	if ($head->so_printCounter != '0'){
