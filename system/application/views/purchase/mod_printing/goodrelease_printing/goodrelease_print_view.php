			...
			<tr>
			 ...
			 <td align="right" valign="middle" nowrap rowspan="2">
			   <table width="90%" border="0" cellspacing="0" cellpadding="0">
			    <tr> 
				 <td width="50%" align="left">No GRL</td>
				 <td width="10">:</td>
			 ...
			 <td colspan="3" valign="top" nowrap>
				<table id="ItemPO" width="100%" border="1" cellspacing="0" cellpadding="2" bgcolor="#C0C0C0">
					<tr align="center" valign="middle" bgcolor="#FFFFFF"> 
						...
						<td width="30%" align="center" nowrap><strong>Nama barang</strong><br/><strong>(Kode)</strong></td>
						<td width="30%" align="center" nowrap><strong>Barang dari pemasok</strong></td>
						...
						echo "<tr bgcolor='#FFFFFF' valign='top'> 
								...
								<table border='0' cellpadding='0' cellspacing='0' width='100%'>
										<tr>
											...
											<td>&nbsp;</td>
											<td>".number_format($detail->qty,$detail->satuan_format)."</td>
										</tr>
									</table>
								</td>
