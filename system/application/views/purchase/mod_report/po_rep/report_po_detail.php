...
<font size='-3'>
  <table width="100%"  border="0" cellpadding="1" cellspacing="1" class="ui-widget-content ui-corner-all">
    <tr bgcolor="#CCCCCC" class="ui-state-default"> 
      <td colspan="14"><?=$this->lang->line('lap_detail_daftar_pesanan');?></td>
    </tr>
    <tr bgcolor="#CCCCCC" class="ui-state-default"> 
    ...
    <tr bgcolor="lightgrey" valign="middle"> 
      ...
      <td  align="left"><?=$row_po->pro_name?><br><?='('.$row_po->pro_code.')'?></td>
    ...
    <tr bgcolor="lightgrey"   class="ui-state-active" > 
      ...
      <td align="right" >
	  	<strong> 
      	  <?=number_format($tot_diskon,$row_po->cur_digit)?>
        </strong>
	  </td>
      <td align="right" >
	  	<strong> 
        	<?=number_format($total,$row_po->cur_digit)?>
        </strong>
	  </td>
    </tr>
  </table>
