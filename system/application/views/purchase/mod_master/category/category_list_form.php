...
?>
	<form id="ubah_form" onsubmit="return editCat();">
	<table align="center">
	<tr>
		<td><?php echo ($this->lang->line('kategori_col_2'));?></td><td>:</td>
		<td>
	...
	<tr>
		<td colspan="3" align="center">
			...
			<input type="button" value="Hapus" onclick="deleteCat('<?=$rows->cat_id?>')">
		</td>
	</tr>
	</table>
	</form>
...
?>
<div align="center"><font color="red"><?php echo ($this->lang->line('kategori_pilih'));?></font></div>
<?php
	endif;
?>
</div>