	  ...
	  <td valign="top">
	    <table width="100%">
		  ...
		  <tr>
			...
			<td class="head_title">:</td>
			<td class="head_title_content">Rp. <?=number_format($list_gr->row()->kurs,2)?>
			</td>
		  </tr>
		  <?php 
			endif;
...
<table align="center" width="99%"  border="0" cellpadding="1" cellspacing="1" class="ui-widget-content ui-corner-all">
	<tr class="ui-widget-header">
	  <td width="1%" valign="top" align="center">No</td>
	  <td width="15%" valign="top" align="center">Barang/Kode</td>
	  <td width="8%" valign="top" align="center">Terima</td>
	  <td width="8%" align="center">Harga satuan <br> ( <?=$list_gr->row()->cur_symbol?> )</td>
	  <td width="8%" align="center">Diskon <br> ( <?=$list_gr->row()->cur_symbol?> )</td>
	  <td width="8%" align="center">Jumlah <br> ( <?=$list_gr->row()->cur_symbol?> )</td>
	  <td width="8%" align="center">PPN 10% <br> ( <?=$list_gr->row()->cur_symbol?> )</td>
	...
	<tr bgcolor="lightgray" baris="<?=$gr_num?>">
	  ...
	  <td valign="top" align="right">
		<div style="float:right" class="calc" id="calc_<?=$gr_num?>"><?=number_format($row_gr->price_disc,$row_gr->cur_digit)?></div>
	  </td>
	  
	  <td valign="top" align="right">
		<div style="float:right" class="calc" id="calc_<?=$gr_num?>"><?=number_format($row_gr->price_tot,$row_gr->cur_digit)?></div>
	  </td>
	
	  <td valign="top" align="right">
		<div style="float:right" class="calc" id="calc_ppn_<?=$gr_num?>"><?=number_format($row_gr->price_ppn,$row_gr->cur_digit)?></div>
	  </td>
	  <td valign="top" align="right">
		<div style="float:right" class="calc" id="calc_tot_ppn_<?=$gr_num?>"><?=number_format($row_gr->price_ppn_tot,$row_gr->cur_digit)?></div>
	  </td>
	</tr>
	<?php 
		$gr_num++;
		...
		$gr_foot = $list_gr_foot->row();
	?>
	<tr>
	<td colspan=6 class="ui-widget-header">&nbsp;</td>
	<td align="right" class="ui-state-active">Total harga : </td>
	<td class="ui-state-active" align="right">
		<div style="float:right" id="total_all"><?=number_format($gr_foot->tot_price_ppn_foot, $gr_foot->cur_digit)?></div>
	</td>
	</tr>
	<?php endif;?>
	</table>
