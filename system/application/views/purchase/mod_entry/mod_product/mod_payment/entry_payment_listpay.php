			...
			$('.dialog_konfirmasi').dialog({
				...
				buttons : { 
					...
					'<?=$this->lang->line('ok')?>' : function() {
						...
						$(form).ajaxSubmit({
							url:'index.php/<?=$link_controller?>/buat_pembayaran',
							type:'POST',
...
<table width="90%" align="center" border="0" cellpadding="1" cellspacing="1" class="ui-widget-content ui-corner-all">
		<tr class="ui-widget-header">
		  ...
		  <td width="20" align="center" >Nilai kontra bon</td>
		  <td width="45%" align="center" >Dibayar</td>
	    </tr>
		<?php 
		...
		<tr bgcolor="lightgray" baris="<?=$no?>">
		  ...
		  <td align="center"><?=$list_bon[$i]['con_no']?></td>
		  
		  <td>
		     <table width="100%" cellpadding="0" cellspacing="0">
			   <tr>
				<td width="10%"><?=$list_bon[$i]['cur_symbol']?></td>
