...
$(document).ready(function (){
	$('.edit').editable('index.php/<?php echo $link_controller;?>/term_update',{
		indicator : 'Saving...',
	...
	$('.deleteterm').click(function() {
		...
		if (del == true){
			$.ajax({
				type: 'POST',
				url: 'index.php/<?php echo $link_controller;?>/delete_term',
				data: "id="+id,
	...
	$('.sort').click(function() {
		...
		$.ajax({
			type: 'POST',
			url: 'index.php/<?php echo $link_controller;?>/list_term',
			data: "sort="+id,
			success: function(data) {
			$('#tabs-1').html(data);
  			},
