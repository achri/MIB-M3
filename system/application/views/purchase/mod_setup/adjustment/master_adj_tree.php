...
$(document).ready(function(){
	...
	$('#setup').click(function() {
		...
		if (joins != '' && pro_id != ''){
			...
			tabs_adjustment(pro_id);
		}else{
			alert('Pilih produk yg akan di sesuaikan');
		}
	});
...
<!-- div style="width:100%;display: table">
	...
	<div id="aktivasi_box" style="width:59%;float: right; display: none;" class="ui-widget-content ui-corner-all">
		<div id="aktivasi_produk"></div>
	</div>
</div>
<br>
...
<tr>
	...
	<td>
	<input type="text" id="pro_name" disabled="disabled">
...
<tr>
	...
	<td>
	<input type="text" id="pro_code" disabled="disabled">
	<input type="hidden" id="is_join">
	</td>
</tr>
<tr>
	<td><input type="button" value="</?=$this->lang->line('setup')?>" id="setup"></td><td>&nbsp</td><td align="right"><input type="button" value="</?=$this->lang->line('cancel')?>"></td>
</tr>
</table>
</div-->
...
<div style="width:100%;display: table">
	<div style="width:39%;float: left;">
		...
		<tr>
			...
			<input type="button" value="<?=$this->lang->line('adjustment')?>" id="setup">&nbsp;<input type="reset" id="Reset" value="<?=$this->lang->line('clear')?>"></td>
		</tr>
		</table>
		</div>
	</div>
	<div id="aktivasi_box" style="width:59%;height:343px;float: right; display: none;" class="ui-widget-content ui-corner-all">
		...
		<?=br(8)?>
		<div align="center"><font color="red">PILIH KATEGORI DAN PRODUK YANG AKAN DI SESUAIKAN</font></div>
		</div>
	</div>
</div>
