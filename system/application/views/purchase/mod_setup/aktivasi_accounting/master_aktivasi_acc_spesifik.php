...
?>
	...
	<td align="left">
	<?=$rows->legal_name.'. '.$rows->sup_name?>
	<input type="hidden" name="inv_id[]" value="<?=$rows->inv_id?>">
	<INPUT TYPE="hidden" id="sup_name_<?=$i?>" NAME="sup_name[]" readonly="readonly" class="required" value="<?=$rows->legal_name.'. '.$rows->sup_name?>" readonly title="<?=$this->lang->line('supp_name')?>">
