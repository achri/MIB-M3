<?php
class master_aktivasi extends MY_Controller {
	public static $link_view, $link_controller, $link_controller_product;
	function master_aktivasi() {
		...
		self::$link_controller = 'mod_master/master_aktivasi';
		self::$link_view = 'purchase/mod_master/aktivasi';
