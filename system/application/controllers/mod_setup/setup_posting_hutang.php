<?php
class setup_posting_hutang extends MY_Controller {
	public static $link_view, $link_controller,$search_year,$search_month;
	function setup_posting_hutang() {
	...
	//	$this->load->model(array('tbl_hutang','tbl_supplier','tbl_gr','tbl_bkbk'));
		...
		self::$link_controller = 'mod_setup/setup_posting_hutang';
		self::$link_view = 'purchase/mod_setup/posting_hutang'; 
