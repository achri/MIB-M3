<?php
class setup_aktivasi_accounting extends MY_Controller {
	public static $link_view, $link_controller, $link_controller_product;
	function setup_aktivasi_accounting() {
		...
		self::$link_controller = 'mod_setup/setup_aktivasi_accounting';
		self::$link_view = 'purchase/mod_setup/aktivasi_accounting';
	...
	function notjoin($pro_id){
		...
		$sql = "select leg.legal_name,inv.sup_id, sup.sup_name, date_format(inv.date_setup,'%d-%m-%Y') as date_setup, inv.inv_begin, inv.inv_id, inv.inv_end 
		from prc_inventory as inv
